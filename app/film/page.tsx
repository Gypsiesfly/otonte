  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="border border-black bg-[#ffc03a] text-black p-6 sm:p-8 lg:p-12 -mt-[1px] flex items-center justify-center">
          <pre className="font-mono text-[5px] leading-tight overflow-hidden text-black w-full max-w-xs md:max-w-md h-auto">
{`*****#********##########***++*********##########%%%#%@@@@@@@@%##*++++++=====--===+**#####**###*#*+::
****##########*##***************+++++*******####%#*##+%@@@@@@%%#*+++++++==---:::::----=++++++****=::
#######***+===-=++********+++====+==++++++****#%@#*****%%%%@%%%#****++++=---::::::::::--==+++++*+-::
#*+===-------=+++******+++==============++++++*%@#*+==##%%%%%###****+++++=--::::::::::---==+++**=-::
