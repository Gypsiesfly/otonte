    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8">
        <div className="flex gap-1 sm:gap-2 items-end relative ml-4 sm:ml-8 lg:ml-12 overflow-x-auto">
          ...
          {/* Music tab - behind film tab */}
          <Link
            href={tabs[1].href}
            className="px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 font-mono text-xs sm:text-sm border border-black border-b-0 rounded-tl-lg sm:rounded-tl-xl rounded-tr-lg sm:rounded-tr-xl bg-[#3b82f6] text-white relative z-10 whitespace-nowrap"
          >
            <span className="font-bold">{tabs[1].number}</span>
            <span className="ml-2 sm:ml-3 lg:ml-4">{tabs[1].label}</span>
          </Link>

          {/* Film tab - active, highest z-index */}
          <Link
            href={tabs[2].href}
            className="px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 font-mono text-xs sm:text-sm border border-black border-b-0 rounded-tl-lg sm:rounded-tl-xl rounded-tr-lg sm:rounded-tr-xl bg-[#ffc03a] text-black relative z-30 whitespace-nowrap"
          >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="border border-black bg-[#ffc03a] text-black p-6 sm:p-8 lg:p-12 -mt-[1px] min-h-[300px] sm:min-h-[350px] lg:min-h-[400px] flex items-center justify-center">
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl md:text-center text-center">
            Film Section - Coming Soon
          </h1>
        </div>
      </section>
    </div>
